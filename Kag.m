...
%     %% TUfRG flow for exchange propogators
%     fprintf('Calculate flow....\n')
...
% str=['Kagome_Tflow_',num2str(Nf),'FFs_kmesh=',num2str(Nl),'_mu=',num2str(mu/t),'t_U=',num2str(U/t),'t_V1=',num2str(V1/t),'t_V2=',num2str(V2/t),'t_V3=',num2str(V3/t),'t_J=',num2str(J/t),'t.mat'];
% save(str,'P','C','D','vmaxflow','lvecs');

str=['Kagome_Tflow_',num2str(Nf),'FFs_qmesh=',num2str(Nq),'_kmesh=',num2str(length(kvecs)),'_Vmax=',num2str(vstop),'_mu=',num2str(mu),'_U=',num2str(U),'_V1=',num2str(V1),'_V2=',num2str(V2),'_V3=',num2str(V3),'.mat'];
